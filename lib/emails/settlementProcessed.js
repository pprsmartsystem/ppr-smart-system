export function settlementProcessedEmail({ name, amount, newBalance, reference, date }) {
  ...
  const rows = [
    ['Transaction Type', 'Spend / Redeem Settlement'],
    ...
    ['Processed On', fmtDate],
    ['Updated Balance', `<strong style="color:#047857;">${fmt(newBalance)}</strong>`],
  ].map(([k, v]) => `
    <tr>
...
<table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;">
  ...
  <tr><td style="background:linear-gradient(135deg,#0f172a 0%,#1e1b4b 50%,#1d4ed8 100%);border-radius:16px 16px 0 0;padding:32px 36px;text-align:center;">
    ...
    <h1 style="color:#fff;font-size:20px;font-weight:700;margin:0 0 6px;">Settlement Credited</h1>
    <p style="color:#a5b4fc;font-size:12px;margin:0;">Spend / Redeem Settlement — Auto-generated notification</p>
  </td></tr>
  ...
  <tr><td style="background:#fff;padding:32px 36px;">
    ...
    <p style="color:#6b7280;font-size:14px;line-height:1.6;margin:0 0 24px;">
      Your spend/redeem settlement has been successfully processed and credited to your wallet.
    </p>

    <!-- Amount -->
    <div style="background:#ecfdf5;border:1px solid #6ee7b7;border-radius:12px;padding:20px;text-align:center;margin-bottom:24px;">
      <p style="color:#065f46;font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:1px;margin:0 0 6px;">Amount Credited to Wallet</p>
    ...
    <div style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:10px;padding:14px 16px;margin-bottom:24px;">
      <p style="color:#1e40af;font-size:12px;line-height:1.6;margin:0;">
        🔒 If you did not expect this credit, contact us at
